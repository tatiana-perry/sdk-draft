...
It will be able to initialize payment providers that need client-side setup such as: [Have others been added?]
* PayPal Express
* Braintree
* Stripe
* Square
...
It can check the state of the checkout such as:
